...
causal_effects <- MLCM(data = data, int_date = int_date, inf_type = "block", PCV = best,
                       nboot = 50, CATE = TRUE, x.cate = x.cate)
...
Finally, we repeat the analysis on the pre-pandemic years (2018 and 2019) to compute placebo treatment effects and export them to produce Panel B of Table III, Figure 2, and Figure 1 reported in Online Appendix, Part 3.
